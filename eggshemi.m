...
% PLACE  : Caltech BIC
% DATES  : 03/16/2004 JMT Adapt from eggkeller.m (JMT)
%
...
for rc = 1:nr
  ...
  fprintf('Rendering orthographic south pole view\n');
  ...
  % Save figure
  pname = sprintf('%sORTHO_%0.3f.tif',eggstub,r(rc));
