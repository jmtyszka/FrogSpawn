...
% PLACE   : California Institute of Technology and City of Hope, Duarte CA
...
% Calculate SPM scale and byte offset of image in .img
...
fwrite(fd, spm_offset, 'float'); % SPM Voxel offset [68 + 4]
fwrite(fd, spm_scale, 'float'); % SPM ROI scale [72 + 4]
fwrite(fd, [0 0], 'float'); % Unused [76 + 8]
